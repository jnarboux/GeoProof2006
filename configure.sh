...
ac_unique_file="float_precision.ml"
ac_subst_vars='SHELL PATH_SEPARATOR PACKAGE_NAME PACKAGE_TARNAME PACKAGE_VERSION PACKAGE_STRING PACKAGE_BUGREPORT exec_prefix prefix program_transform_name bindir sbindir libexecdir datadir sysconfdir sharedstatedir localstatedir libdir includedir oldincludedir infodir mandir build_alias host_alias target_alias DEFS ECHO_C ECHO_N ECHO_T LIBS OCAMLC OCAMLOPT OCAMLCDOTOPT OCAMLOPTDOTOPT OCAMLDEP OCAMLLEX OCAMLYACC OCAMLBEST OCAMLVERSION OCAMLLIB VERSION DATE COMPUTATION_MODULE COMPUTATION_FILE CREALLIB LIBOBJS LTLIBOBJS'
ac_subst_files=''
...
Optional Features:
  ...
  --disable-creal: disable the use of the creal library to perform arbitrary precision computations
...
echo "${ECHO_T}no" >&6
	...
	echo "$as_me:$LINENO: checking ocamlopt.opt version" >&5
echo $ECHO_N "checking ocamlopt.opt version... $ECHO_C" >&6
...
# Check whether --enable-creal or --disable-creal was given.
if test "${enable_creal+set}" = set; then
  enableval="$enable_creal"
  CREAL="$enableval"
fi;
...
PKG_GTK=gtk+-2.0
echo "$as_me:$LINENO: checking for GTK+ - version >= $REQUIRED_GTK" >&5
echo $ECHO_N "checking for GTK+ - version >= $REQUIRED_GTK... $ECHO_C" >&6
if pkg-config --atleast-version $REQUIRED_GTK $PKG_GTK; then
        echo "$as_me:$LINENO: result: yes" >&5
echo "${ECHO_T}yes" >&6
        PKG_RSVG=librsvg-2.0
        echo "$as_me:$LINENO: checking for librsvg - version >= $REQUIRED_RSVG" >&5
echo $ECHO_N "checking for librsvg - version >= $REQUIRED_RSVG... $ECHO_C" >&6
...
echo "$as_me:$LINENO: checking for $LABLGTK_NAME with lablrsvg support." >&5
echo $ECHO_N "checking for $LABLGTK_NAME with lablrsvg support.... $ECHO_C" >&6
...
echo "$as_me:$LINENO: checking for Xml-light" >&5
echo $ECHO_N "checking for Xml-light... $ECHO_C" >&6
...
if test "$CREAL" = "true"; then
  echo "$as_me:$LINENO: checking for C-Real" >&5
echo $ECHO_N "checking for C-Real... $ECHO_C" >&6
...
# Finally create the Makefile from Makefile.in
                                                  ac_config_files="$ac_config_files Makefile autoconf.ml geometric_functions.ml distrib/rpms/geoproof.spec distrib/windows/geoproof.nsi"
...
do
  ...
  "autoconf.ml" ) CONFIG_FILES="$CONFIG_FILES autoconf.ml" ;;
  "geometric_functions.ml" ) CONFIG_FILES="$CONFIG_FILES geometric_functions.ml" ;;
  "distrib/rpms/geoproof.spec" ) CONFIG_FILES="$CONFIG_FILES distrib/rpms/geoproof.spec" ;;
  "distrib/windows/geoproof.nsi" ) CONFIG_FILES="$CONFIG_FILES distrib/windows/geoproof.nsi" ;;
...
s,@OCAMLCDOTOPT@,$OCAMLCDOTOPT,;t t
s,@OCAMLOPTDOTOPT@,$OCAMLOPTDOTOPT,;t t
s,@OCAMLDEP@,$OCAMLDEP,;t t
s,@OCAMLLEX@,$OCAMLLEX,;t t
s,@OCAMLYACC@,$OCAMLYACC,;t t
s,@OCAMLBEST@,$OCAMLBEST,;t t
s,@OCAMLVERSION@,$OCAMLVERSION,;t t
s,@OCAMLLIB@,$OCAMLLIB,;t t
s,@VERSION@,$VERSION,;t t
s,@DATE@,$DATE,;t t
s,@COMPUTATION_MODULE@,$COMPUTATION_MODULE,;t t
s,@COMPUTATION_FILE@,$COMPUTATION_FILE,;t t
s,@CREALLIB@,$CREALLIB,;t t
