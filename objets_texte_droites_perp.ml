...
class type t_objet_texte_droites_perp =
object
...
class objet_texte_droites_perp coordsinit l1 l2 =
object (self)
  inherit objet_texte
  ...
  method recalcule =
    ...
    if (are_orthogonal e1 e2) then 
      self#set_text (i18n "Orthogonal") else 
      self#set_text (i18n "Not orthogonal")
  ...
  method predicate_form () = Some (Atom(R("perpendicular",[Var(l1#objet_nom);Var(l2#objet_nom)])))
